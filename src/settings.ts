...
import { DEFAULT_CODE_FONT_ID, DEFAULT_FONT_ID, type BeautifySettings } from './fonts.ts'
import { DEFAULT_MOTION_CHOICE } from './motion.ts'
import { DEFAULT_MIRRORS } from './source.ts'

export { FONT_SETTINGS_NS } from './params.ts'
export type { BeautifySettings } from './fonts.ts'

/** Live fields this plugin projects to the settings page. */
export interface Config {
  /** Face applied to body text, or the system default. */
  font: Volatile<BeautifySettings['font']>
