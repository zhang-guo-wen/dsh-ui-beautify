...
//#endregion
export { CACHE_ROUTE, CODE_FACES, CODE_FALLBACK_STACK, CODE_FONT_CHOICES, Config, DEFAULT_CODE_FONT_ID, DEFAULT_FONT_ID, DEFAULT_MIRRORS, FACE_ID_PATTERN, FONTS_ROUTE, FONT_CHOICES, FONT_FACES, FONT_ROLES, FONT_SETTINGS_NS, FontStore, SYSTEM_FONT_ID, anyFaceById, apply, choicesFor, downloadFile, faceById, fontRouteFor, fontStack, inject, mirrorUrl, name, resolveCacheDir, resolveFontChoice, serveCacheUsage, serveFontFile };
