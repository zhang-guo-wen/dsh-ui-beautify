...
//#endregion
export { Config, DEFAULT_FONT_ID, DEFAULT_MIRRORS, FACE_ID_PATTERN, FONTS_ROUTE, FONT_CHOICES, FONT_FACES, FONT_SETTINGS_NS, FontStore, SYSTEM_FONT_ID, apply, downloadFile, faceById, fontRouteFor, fontStack, inject, mirrorUrl, name, resolveCacheDir, resolveFontChoice, serveFontFile };
